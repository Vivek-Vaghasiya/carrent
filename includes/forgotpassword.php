...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT emailid FROM tblcust WHERE emailid=:email and mobileno=:mobile";
...
<div class="modal fade" id="forgotpassword">
  ...
  <div class="form-group">
              ...
              <div class="text-center">
                ...
                <p><a data-toggle="modal" data-dismiss="modal"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Back to Login</a></p>
              </div>
            </div>
          </div>
        </div>
