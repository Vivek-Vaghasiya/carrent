...
$sql ="SELECT password FROM tblcust WHERE emailid=:email and password=:password";
...
if($query -> rowCount() > 0)
{
$con="update tblcust set password=:newpassword where emailid=:email";
...
<title>Rent Smart - Responsive Car Dealer HTML5 Template</title>
