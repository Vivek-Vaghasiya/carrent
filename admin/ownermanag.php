...
<head>
	...
	<title>Rent Smart |Admin Manage Owners   </title>
...
{	
	...
	?>	
										<tr>
											...
											<td><?php echo htmlentities($result->govermentid);?></td>
...
{
	?><a href="ownermanag.php?aeid=<?php echo htmlentities($result->ownerid);?>" onclick="return confirm('Do you really want to Active')"> Inactive</a>
<?php } else {?>

<a href="ownermanag.php?eid=<?php echo htmlentities($result->ownerid);?>" onclick="return confirm('Do you really want to Inactive')"> Active</a>
</td>
<?php } ?></td>																				
										</tr>
										<?php $cnt=$cnt+1;} }} ?>
