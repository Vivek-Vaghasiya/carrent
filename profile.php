...
$sql="update tblcust set fullname=:name,mobileno=:mobileno where emailid=:email";
...
<title>Rent Smart | My Profile</title>
          ...
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" name="mobilenumber" value="<?php echo htmlentities($result->mobileno);?>" id="phone-number" type="text" required>
            </div>
